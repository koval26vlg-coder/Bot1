...
Успешный старт сопровождается сообщением вида `🚀 ADVANCED TRIANGULAR ARBITRAGE BOT STARTING 🚀`, активацией нескольких WebSocket-соединений Bybit и включением мониторинга (`🔄 Advanced monitoring loop started`).

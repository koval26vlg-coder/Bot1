...
При старте конфигурация запрашивает список доступных инструментов через публичный REST Bybit, сортирует их по 24-часовому обороту и ограничивает работу бота первыми 20 тикерами. Это ускоряет обнаружение связок и снижает шум от неликвидных пар.
